  ...
  return (
    <div className='h-screen flex items-center flex-col justify-start p-8 sm:mt-10'>
      ...
      <div className='flex items-center justify-center'>
        <h1 className='font-bold text-darkpurple2 text-2xl lg:text-4xl text-center p-2'>Digital collectible avatars living on the Ethereum blockchain.</h1>
      </div>
      {/* Description */}
      <div className='flex items-start justify-center w-full lg:w-3/5'>
        <p className='text-md text-center text-darkpurple2 font-medium p-2'>
