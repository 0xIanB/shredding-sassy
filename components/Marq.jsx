...
const styles = {
  container: 'flex flex-col items-center w-full z-10 2xl:pt-20 -mt-20 md:-mt-10',
  marqueecontainer: 'text-[30px] md:text-[45px] lg:text-[60px] 2xl:text-[100px] tracking-widest scroll-hidden text-gray-800/30 font-bold font-lond py-20',
