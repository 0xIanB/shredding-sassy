...
const terms = () => {
  return (
    <div class='h-screen text-pri'>
      ...
      <Navbar />
      <div class='flex items-center text-center justify-center p-20'>
        <h2 class='mainBodyHeaderStyle font-bold font-mont text-pri pt-4 pb-2 '>TERMS & CONDITIONS</h2>
      </div>
      
      <div class={styles.textContainer}>
        <h2 class={`mainBodyHeaderStyle ${styles.header}`}>
          GENERAL TERMS AND CONDITIONS
        </h2>
        <p class={`mainBodyTextStyle ${styles.textBlock}`}>
