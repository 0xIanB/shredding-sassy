...
const styles = {
  textContainer: 'flex flex-col mx-24 xl:mx-48 pb-10',
  header: 'font-bold font-body p-2',
  textBlock: 'font-body p-2',
}
  ...
  return (
    <div class='h-screen text-pri'>
      ...
      <div class='flex items-center text-center justify-center p-20'>
        <h2 class='font-bold font-mont text-pri pt-4 pb-2 '>TERMS & CONDITIONS</h2>
      </div>
