...
const sssc = () => {
  return (
    ...
    <Navbar />
      <div className='flex flex-col 2xl:mx-20 max-w-[3400px]'>
        {/* Header */}
      <div className='flex flex-col xl:flex-row mt-20 justify-center items-center xl:justify-between mb-10 lg:mb-6 '>
        {/* Left Side */}
        <div className='flex flex-col justify-center items-center xl:items-start space-y-8'>
          {/* Title */}
            <div className='flex 2xl:hidden justify-center xl:justify-start'>
              <Image
                src={brownstroke}
                alt='Team Shredders'
                width={700}
            ...
            <div className='hidden 2xl:flex justify-center xl:justify-start'>
              <Image
                src={brownstroke}
                alt='Team Shredders'
                width={900}
          ...
          {/* Info */}
          <div className='flex xl:px-0 flex-col text-center xl:text-start xl:ml-20 justify-center md:w-[70%] lg:w-[45%] 2xl:w-[70%] 3xl:w-[70%]'>
      ...
      {/* Main Container */}
      <Accordion allowMultiple className='hidden xl:flex flex-row flex-wrap justify-evenly mb-20 mt-16'>
        {/* Item 1 */}
        <div className='flex flex-col -mt-8'>
        <AccordionItem className='AccStyle 3xl:wideAccStyle mb-10'>
          {({ isExpanded }) => (
            <>
